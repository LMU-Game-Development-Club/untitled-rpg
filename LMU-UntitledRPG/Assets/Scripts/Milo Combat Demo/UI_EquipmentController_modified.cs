...
public class UI_EquipmentController_2 : MonoBehaviour
{
    ...
    void UpdateSlots() {
        ...
        // Notify parent object about head slot change
        transform.parent.GetComponent<MiloCombatManagerScript>().limbChanged("Head", HeadSlot.name);
        ...
        // Notify parent object about hand slot change
        transform.parent.GetComponent<MiloCombatManagerScript>().limbChanged("Hand", HandSlot.name);
    }
}
